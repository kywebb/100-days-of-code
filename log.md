...
**Today's Progress**: Fixed portfolio website. Updated it with more client websites. My goal is to do every single easy Leetcode problem, so here we go!
...
# Restart of 100 Days Of Code - Log

### Day 0: February 19, 2026

**Today's Progress**: 
Making considerable progress on the JavaScript course I paid for. I'm learning a lot of intricacies with the JavaScript course, but I need to transition to more Leetcode problems to practice problems in Data Structures/Algorithm.
...
**Today's Progress**: 
Getting back into Leetcode problems. 
...
**Today's Progress**: 
Reviewing deeply time complexity, data structures in relation to Cloudflare.
...
**Today's Progress**: 
Getting more direction and narrowing down what I need to focus on.
...
**Link to work:** 
1. [Worked on Javascript Skills](https://learnjavascript.online/app.html?id=1780)
2. [HackerRank Problem: Count Elements Greater Than Previous Average](https://www.hackerrank.com/contests/software-engineer-prep-kit/challenges/count-elements-greater-than-previous-average)
...
**Link to work:** 
1. [Worked on Javascript Skills](https://learnjavascript.online/app.html?id=1780)
2. [HackerRank Problem: Find the Smallest Missing Positive Integer](https://www.hackerrank.com/contests/software-engineer-prep-kit/challenges/find-smallest-missing-positive-integer)
...
**Link to work:** 
1. [Worked on Javascript Skills](https://learnjavascript.online/app.html?id=1780)
2. [HackerRank Problem: Check Palindrome by Filtering Non-Letters](https://www.hackerrank.com/contests/software-engineer-prep-kit/challenges/check-palindrome-filter-non-letters)
...
**Link to work:** 
1. [Worked on Javascript Skills](https://learnjavascript.online/app.html?id=1780)
2. [HackerRank Problem: Check for Non-Identical String Rotation](https://www.hackerrank.com/contests/software-engineer-prep-kit/challenges/check-non-identical-string-rotation)
...
2. [HackerRank Problem: Target Index Search](https://www.hackerrank.com/contests/software-engineer-prep-kit/challenges/lookup-with-binary-search)
3. [Read Cloudflare Article from OnePage](https://www.linkedin.com/pulse/cloudflare-named-current-company-beat-gartner-report-edge-distribution-zor3c/)
4. [Read Cloudflare Article from OnePage](https://www.cloudflare.com/press/press-releases/2025/cloudflare-helps-protect-independent-journalism-and-non-profits-from-ai/)
5. [Read Cloudflare Article from OnePage](https://builtin.com/awards/us/2025/best-large-places-to-work?utm_medium=website&utm_source=editorial&utm_campaign=bptw-2025&utm_content=article)
6. [Read Cloudflare Article from OnePage](https://www.securityweek.com/cloudflare-blocks-record-11-5-tbps-ddos-attack/)
7. [Read Cloudflare Article from OnePage](https://indiscretemusings.substack.com/p/on-cloudflare?utm_campaign=post-expanded-share&utm_medium=web&triedRedirect=true)
...
**Containerization:** 
Wrote a Dockerfile to package my Go application into a lightweight image.
**Orchestration:** 
Authored Kubernetes Deployment manifests to manage a 3-replica set of the service, ensuring high availability.
**Service Discovery:** 
Implemented a LoadBalancer service to expose the internal pod network to my local machine on port 80.
**Health Monitoring:** 
Refactored the Go source code to include a root-level health check endpoint for liveness probes.

**Technical Skills Gained:**
**K8s Objects:** 
Deployments, Services, Pods, and ReplicaSets.
**kubectl CLI:** 
Mastering apply, rollout restart, logs -l, and get pods -w.
**Networking:** 
Mapping external ports (80) to container target ports (8080) via a virtual LoadBalancer.
