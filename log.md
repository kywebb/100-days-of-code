...
Containerization: Wrote a Dockerfile to package my Go application into a lightweight image.
    ...
    Health Monitoring: Refactored the Go source code to include a root-level health check endpoint for liveness probes.

**Technical Skills Gained:**

    K8s Objects: Deployments, Services, Pods, and ReplicaSets.

    kubectl CLI: Mastering apply, rollout restart, logs -l, and get pods -w.

    Networking: Mapping external ports (80) to container target ports (8080) via a virtual LoadBalancer.
